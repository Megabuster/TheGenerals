...
*/
       ...
       board = [[{"name":"BCO","value":24,"color":"black"},{"name":"BS3","value":27,"color":"black"},{"name":"BPR","value":17,"color":"black"},{"name":"EMP","value":0,"color":"gray"},{"name":"BPR","value":17,"color":"black"},{"name":"BS2","value":26,"color":"black"},{"name":"BPR","value":17,"color":"black"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"}],[{"name":"BMA","value":22,"color":"black"},{"name":"BL1","value":20,"color":"black"},{"name":"BPR","value":17,"color":"black"},{"name":"BS5","value":29,"color":"black"},{"name":"BL2","value":19,"color":"black"},{"name":"EMP","value":0,"color":"gray"},{"name":"BS4","value":28,"color":"black"},{"name":"BPR","value":17,"color":"black"},{"name":"BSE","value":18,"color":"black"}],[{"name":"BSP","value":30,"color":"black"},{"name":"BLC","value":23,"color":"black"},{"name":"BCA","value":21,"color":"black"},{"name":"BSP","value":30,"color":"black"},{"name":"EMP","value":0,"color":"gray"},{"name":"BFL","value":16,"color":"black"},{"name":"BPR","value":17,"color":"black"},{"name":"BS1","value":25,"color":"black"},{"name":"EMP","value":0,"color":"gray"}],[{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"}],[{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"}],[{"name":"WS1","value":10,"color":"white"},{"name":"WMA","value":7,"color":"white"},{"name":"WLC","value":8,"color":"white"},{"name":"EMP","value":0,"color":"gray"},{"name":"WFL","value":1,"color":"white"},{"name":"WL2","value":4,"color":"white"},{"name":"WS4","value":13,"color":"white"},{"name":"WPR","value":2,"color":"white"},{"name":"WS3","value":12,"color":"white"}],[{"name":"WCO","value":9,"color":"white"},{"name":"EMP","value":0,"color":"gray"},{"name":"WPR","value":2,"color":"white"},{"name":"WS2","value":11,"color":"white"},{"name":"EMP","value":0,"color":"gray"},{"name":"WPR","value":2,"color":"white"},{"name":"WPR","value":2,"color":"white"},{"name":"WSE","value":3,"color":"white"},{"name":"WS5","value":14,"color":"white"}],[{"name":"WSP","value":15,"color":"white"},{"name":"EMP","value":0,"color":"gray"},{"name":"EMP","value":0,"color":"gray"},{"name":"WPR","value":2,"color":"white"},{"name":"EMP","value":0,"color":"gray"},{"name":"WL1","value":5,"color":"white"},{"name":"WCA","value":6,"color":"white"},{"name":"WSP","value":15,"color":"white"},{"name":"WPR","value":2,"color":"white"}]];
       //board = angular.copy(setupInitialBoard(board));
       lastBoard = board;
       moveMade = true;
       return board;
  ...
  export function showBoardConsole(board: Board) {
    for (let i = 0; i < ROWS; i++) {
      let rowName: string = "";
      for (let j = 0; j < COLS; j++) {
        let pieceName: string = board[i][j].name;
        rowName+=pieceName + " ";
      }
      console.log(rowName);
    }
