...
module gameLogic {
  ...
  function setupInitialBoard(board: Board) {
    /**
  ...
  function addToBoard(Board: Board, turnIndexOfMove: number, row: number, col: number) {
  ...
  export function createMove(
    ...
    if (winner !== '') { //removed instances of:  || isTie(boardAfterMove)
      // Game over.
